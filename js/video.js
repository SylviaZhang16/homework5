...
document.getElementById("slower").setAttribute("onclick", "slower()");
document.getElementById("faster").setAttribute("onclick", "faster()");
document.getElementById("skip").setAttribute("onclick", "skip()");
